 ...
 */
final class Version20211121094542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE findings (id INT AUTO_INCREMENT NOT NULL, category VARCHAR(200) NOT NULL, description VARCHAR(255) NOT NULL, location VARCHAR(255) DEFAULT NULL, time DATE DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, mail_adress VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', additional_information VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
